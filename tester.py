...
# load network
enc_model.load_networks(epoch, load_dir="/Results/RetinaNet_runs/s2r2023_02_01_14h38m52s")
dec_model.load_networks(epoch, load_dir="/Results/RetinaNet_runs/s2r2023_02_01_14h38m52s")
joint_model.initialize(opt_exp, enc_model, dec_model, gpu_ids = opt_exp.gpu_ids)
# if opt_exp.n_decoders == 2:
...
total_loss, test_accuracy, error = trainer.test(joint_model,
    test_loader, 
    experiment,
    save_output=True,
...
print(f"total_loss: {total_loss}, test_accuract: {test_accuracy}")
